...
// ================================================
// Class Name: MoodTracker
// Purpose: To record and display the user's moods
// Used in: Diary Application (Deliverable 1)
// ================================================
...
public class MoodTracker {
    ...
    // --------------------------------------------
    // Method: addMood
    // Purpose: Adds a new mood to the array
    // --------------------------------------------
    public void addMood(String mood) {
        if (moodCount < moods.length) {
            ...
            System.out.println("⚠️ Mood list is full. Cannot add more moods.");
        }
    }

    // --------------------------------------------
    // Method: viewMoods
    // Purpose: Displays all recorded moods
    // --------------------------------------------
