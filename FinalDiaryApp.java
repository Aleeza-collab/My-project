...
public class FinalDiaryApp {
    ...
    public static void runDiaryApp(User currentUser) {
        ...
        ToDoListManager todoManager = new ToDoListManager(50); // 📝 NEW: To-Do list manager (max 50 tasks)
        ...
        do {
            ...
            System.out.println("6. To-Do List 📝"); // NEW OPTION
            System.out.println("7. Logout"); // LOGOUT MOVED TO 7
    ...
    private static void reminderSection(Scanner sc, ReminderManager rm) {
        ...
        do {
            ...
            System.out.println("3. Back");
            System.out.println("4. Delete Reminder"); // You might want to add this later!
            System.out.print("Enter choice: ");
    ...
    public static void main(String[] args) {
        ...
        int option = 0; // Initialize option to control loop start
        while (option != 3) {
            ...
            switch (option) {
                ...
                case 3 -> {
                    ...
                    // Loop naturally terminates due to while (option != 3)
                }
